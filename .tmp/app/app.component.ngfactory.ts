...
class _View_MyApp0 extends import1.AppView<import3.MyApp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Header_2_3 = new import13.Header(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    ...
    this._Toolbar_4_4 = new import13.Toolbar(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import14.ToolbarTitle(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4,this.parentInjector.get(import29.Navbar,(null as any)));
    ...
    this._Content_11_4 = new import15.Content(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_11),this.renderer,this.parentInjector.get(import31.App),this.parentInjector.get(import23.Keyboard),this.parentInjector.get(import24.NgZone),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import32.Tabs,(null as any)));
    ...
    this._List_13_3 = new import16.List(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import25.GestureController));
    ...
    var compView_21:any = import35.viewFactory_Nav0(this.viewUtils,this.injector(21),this._appEl_21);
    this._Nav_21_4 = new import18.Nav(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import36.NavControllerBase,(null as any)),this.parentInjector.get(import31.App),this.parentInjector.get(import22.Config),this.parentInjector.get(import23.Keyboard),new import21.ElementRef(this._el_21),this.parentInjector.get(import24.NgZone),this.renderer,this.parentInjector.get(import37.ComponentFactoryResolver),this.parentInjector.get(import25.GestureController),this.parentInjector.get(import38.TransitionController),this.parentInjector.get(import39.DeepLinker,(null as any)));
    this._appEl_21.initComponent(this._Nav_21_4,([] as any[]),compView_21);
    compView_21.create(this._Nav_21_4,([] as any[]),(null as any));
    ...
    this._viewQuery_Nav_0.reset([this._Nav_21_4]);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import16.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._List_13_3; }
    if (((token === import15.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_11_4; }
    if (((token === import12.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Menu_0_4; }
    if (((token === import18.Nav) && (21 === requestNodeIndex))) { return this._Nav_21_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changed = false;
    const currVal_0:any = this._Nav_21_4;
    ...
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._Nav_21_4.root = currVal_4;
      this._expr_4 = currVal_4;
    }
    const currVal_5:any = 'false';
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._Nav_21_4.swipeBackEnabled = currVal_5;
    ...
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Nav_21_4.ngAfterViewInit(); } }
  }
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  _MenuClose_0_6:import41.MenuClose;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Item_0_4 = new import40.Item(this.parent.parentInjector.get(import43.Form),this.parent.parentInjector.get(import22.Config),new import21.ElementRef(this._el_0),this.renderer);
    this._ItemContent_0_5 = new import40.ItemContent();
    this._MenuClose_0_6 = new import41.MenuClose(this.parent.parentInjector.get(import20.MenuController));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import41.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._MenuClose_0_6; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = '';

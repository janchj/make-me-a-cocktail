...
import * as import10 from '../../shared/asset-service';
...
import * as import36 from '../../node_modules/ionic-angular/components/searchbar/searchbar.ngfactory';
...
class _View_HomePage_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._HomePage_0_4 = new import3.HomePage(this.parentInjector.get(import8.NavController),this.parentInjector.get(import9.CocktailService),this.parentInjector.get(import10.AssetService));
...
export const HomePageNgFactory:import12.ComponentFactory<import3.HomePage> = new import12.ComponentFactory<import3.HomePage>('home-page',viewFactory_HomePage_Host0,import3.HomePage);
...
class _View_HomePage0 extends import1.AppView<import3.HomePage> {
  ...
  _Searchbar_16_4:import22.Searchbar;
  _text_17:any;
  _anchor_18:any;
  /*private*/ _appEl_18:import2.AppElement;
  _TemplateRef_18_5:any;
  _NgFor_18_6:import23.NgFor;
  _text_19:any;
  _text_20:any;
  /*private*/ _expr_0:any;
  /*private*/ _expr_1:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MenuToggle_4_5 = new import16.MenuToggle(this.parentInjector.get(import30.MenuController),new import25.ElementRef(this._el_4),this.parentInjector.get(import26.ViewController,(null as any)),this._Navbar_2_4);
    ...
    this._text_10 = this.renderer.createText((null as any),'Home',(null as any));
    ...
    this.renderer.setElementAttribute(this._el_16,'placeholder','Find a cocktail');
    this._appEl_16 = new import2.AppElement(16,14,this,this._el_16);
    var compView_16:any = import36.viewFactory_Searchbar0(this.viewUtils,this.injector(16),this._appEl_16);
    this._Searchbar_16_4 = new import22.Searchbar(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_16),this.renderer,this.parentInjector.get(import37.NgControl,(null as any)));
    ...
    this._TemplateRef_18_5 = new import38.TemplateRef_(this._appEl_18,viewFactory_HomePage1);
    this._NgFor_18_6 = new import23.NgFor(this._appEl_18.vcRef,this._TemplateRef_18_5,this.parentInjector.get(import39.IterableDiffers),this.ref);
    ...
    var disposable_1:Function = this.renderer.listen(this._el_16,'search',this.eventHandler(this._handle_search_16_0.bind(this)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import22.Searchbar) && (16 === requestNodeIndex))) { return this._Searchbar_16_4; }
    if (((token === import38.TemplateRef) && (18 === requestNodeIndex))) { return this._TemplateRef_18_5; }
    if (((token === import23.NgFor) && (18 === requestNodeIndex))) { return this._NgFor_18_6; }
    if (((token === import21.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 19)))) { return this._Content_14_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_9:any = 'Find a cocktail';
    if (import4.checkBinding(throwOnChange,this._expr_9,currVal_9)) {
      this._Searchbar_16_4.placeholder = currVal_9;
      this._expr_9 = currVal_9;
    }
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._Searchbar_16_4.ngOnInit(); }
    changes = (null as any);
    const currVal_16:any = this.context.allCocktails;
    if (import4.checkBinding(throwOnChange,this._expr_16,currVal_16)) {
      this._NgFor_18_6.ngForOf = currVal_16;
    ...
    const currVal_10:any = this._Searchbar_16_4.animated;
    if (import4.checkBinding(throwOnChange,this._expr_10,currVal_10)) {
      this.renderer.setElementClass(this._el_16,'searchbar-animated',currVal_10);
      this._expr_10 = currVal_10;
    }
    const currVal_11:any = this._Searchbar_16_4._value;
    if (import4.checkBinding(throwOnChange,this._expr_11,currVal_11)) {
      this.renderer.setElementClass(this._el_16,'searchbar-has-value',currVal_11);
      this._expr_11 = currVal_11;
    }
    const currVal_12:any = this._Searchbar_16_4._isActive;
    if (import4.checkBinding(throwOnChange,this._expr_12,currVal_12)) {
      this.renderer.setElementClass(this._el_16,'searchbar-active',currVal_12);
      this._expr_12 = currVal_12;
    }
    const currVal_13:any = this._Searchbar_16_4.showCancelButton;
    if (import4.checkBinding(throwOnChange,this._expr_13,currVal_13)) {
      this.renderer.setElementClass(this._el_16,'searchbar-show-cancel',currVal_13);
      this._expr_13 = currVal_13;
    }
    const currVal_14:any = this._Searchbar_16_4._shouldAlignLeft;
    if (import4.checkBinding(throwOnChange,this._expr_14,currVal_14)) {
      this.renderer.setElementClass(this._el_16,'searchbar-left-aligned',currVal_14);
      this._expr_14 = currVal_14;
    }
    const currVal_15:any = this._Searchbar_16_4._sbHasFocus;
    if (import4.checkBinding(throwOnChange,this._expr_15,currVal_15)) {
      this.renderer.setElementClass(this._el_16,'searchbar-has-focus',currVal_15);
  ...
  private _handle_search_16_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.getCocktails($event)) !== false);
    return (true && pd_0);
  }
}
...
class _View_HomePage1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Card_0_3 = new import40.Card(this.parent.parentInjector.get(import24.Config),new import25.ElementRef(this._el_0),this.renderer);
    this._text_1 = this.renderer.createText(this._el_0,'\n    ',(null as any));
    ...
    this._Avatar_4_3 = new import42.Avatar();
    ...
    this.renderer.setElementAttribute(this._el_12,'name','star');
    this.renderer.setElementAttribute(this._el_12,'role','img');
    this._Icon_12_3 = new import19.Icon(this.parent.parentInjector.get(import24.Config),new import25.ElementRef(this._el_12),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import42.Avatar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._Avatar_4_3; }
    if (((token === import19.Icon) && (12 === requestNodeIndex))) { return this._Icon_12_3; }
    if (((token === import41.Item) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Item_2_4; }
    if (((token === import41.ItemContent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._ItemContent_2_5; }
    if (((token === import40.Card) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Card_0_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) {
      ...
      if (this._query_Icon_2_2.dirty) {
        this._query_Icon_2_2.reset([this._Icon_12_3]);
    ...
    const currVal_0:any = import4.interpolate(1,'',this.parent.context.getCocktailImageUrl(this.context.$implicit.id),'');
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
    ...
    const currVal_6:any = import4.interpolate(1,'Something... ',this.parent.context.getCocktailTastingNotes(this.context.$implicit.tastes),'');
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
  ...
  private _handle_click_9_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.goToCocktailPage(this.context.$implicit)) !== false);
    return (true && pd_0);
  }
  private _handle_click_12_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.setCocktailAsFavourite(this.context.$implicit)) !== false);
    return (true && pd_0);
  }
}
